 ...
 */
public class PortManagerGS0 {
    private final static String TAG = MainActivity.TAG;
    

    public interface PortManagerGS0Listener{
        public void onServiceConnectedGS0();
    }
    public PortManagerGS0(Activity activity,PortManagerGS0Listener listener){
        this.mActivity = activity;
        this.mListener = listener;
    }
    private Activity mActivity;
    private PortManagerGS0Listener mListener;
    ...
    private ServiceConnection mConnectionService = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            mListener.onServiceConnectedGS0();
        }
    };
    ...
    public void onPortStart(){
        ...
        intent.setAction("com.xcheng.wiredecr.IWireEcrServiceGS");
