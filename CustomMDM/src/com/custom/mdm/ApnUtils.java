...
public class ApnUtils {
    ...
    public static int deleteAPN(Context context, int id) {
        ...
        Log.d(TAG, "Delete APN " + id + ", deleted " + delete);
        return delete;
    }

    public static int resetAPN(Context context) {
        ContentResolver resolver = context.getContentResolver();
        int delete = resolver.delete(DEFAULTAPN_URI, null, null);
        Log.d(TAG, "Reset APN, deleted " + delete);
        return delete;
    }
}
