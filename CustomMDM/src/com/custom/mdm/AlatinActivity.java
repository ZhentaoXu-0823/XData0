...
public class AlatinActivity extends Activity implements View.OnClickListener {
    ...
    private void initButton() {
        ...
        setButtonOnclick(R.id.btn_set_simdata);
        setButtonOnclick(R.id.btn_get_phone_number);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_get_dataSimSlotIndex:
                ...
                break;
            case R.id.btn_set_simdata:
                int dataSimIndex = Integer.parseInt(getEditText(R.id.et_set_simdata));
                int defaultDataSim = CustomAPI.simDataSwitch(dataSimIndex);
                Toast.makeText(mContext, "DATA SIM SLOT INDEX: " + defaultDataSim, Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.btn_get_phone_number:
                int phoneNumIndex = Integer.parseInt(getEditText(R.id.et_get_phone_number));
                String phoneNumber = CustomAPI.getPhoneNumber(phoneNumIndex);
                Toast.makeText(mContext, "SIM index: " + phoneNumIndex + ";  PhoneNumber: " + phoneNumber, Toast.LENGTH_SHORT).show();
                break;
            default:
