...
public class MainActivity extends Activity {
    ...
    View.OnClickListener mClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.save_wifi: {
                    int netId = CustomAPI.saveWifiConfig("ASUS-GMS", "googletest", 4/*WifiConfiguration.KeyMgmt.WPA2_PSK*/);
                    Toast.makeText(mContext, "Save WiFi\"ASUS-GMS\", netId = " + netId, Toast.LENGTH_SHORT).show();
                    break;
                }
                case R.id.get_imsi: {
                ...
                case R.id.reset_apn: {
                    int delete = CustomAPI.resetAPN();
                    String msg = "Reset APN " + delete + " line";
    ...
    public static String listToStr(String title, List<String> list) {
