...
public class AidlService extends Service {
    ...
    ICustomAPI.Stub stub = new ICustomAPI.Stub() {
        ...
        @Override
        public int resetAPN() throws RemoteException {
            return ApnUtils.resetAPN(AidlService.this);
        }

        @Override
        public List<String> getCertificates(int type) throws RemoteException {
            return Certificate.getCertificates(type);
        }

        @Override
        public void installCA(String path) throws RemoteException {
            Certificate.installCA(AidlService.this, path);
        }

        @Override
        public void uninstallCA(String name) throws RemoteException {
            Certificate.uninstallCA(AidlService.this, name);
        }

        @Override
        public int setNetworkWhitelist(List<String> ipList, List<String> ssidList) throws RemoteException {
            return NetworkRules.setNetworkWhitelist(ipList, ssidList);
        }

        @Override
        public int setNetworkBlacklist(List<String> ipList, List<String> ssidList) throws RemoteException {
            return NetworkRules.setNetworkBlacklist(ipList, ssidList);
        }

        @Override
        public int clearNetworkRules() throws RemoteException {
            return NetworkRules.clearNetworkRules();
        }

        @Override
        public int pin_set_direction(int direction) throws RemoteException {
            return Gpio.pin_set_direction(direction);
        }

        @Override
        public int pin_set_output(int level) throws RemoteException {
            return Gpio.pin_set_output(level);
        }

        @Override
        public int pin_get_level() throws RemoteException {
            return Gpio.pin_get_level();
        }

        @Override
        public boolean open(String port, int baud, int data_bits, int parity, int stop_bits) throws RemoteException {
            return SerialPort.open(port, baud, data_bits, parity, stop_bits);
        }
        ...
        public boolean write(byte[] bytes) throws RemoteException {
            return SerialPort.write(bytes);
        }

        @Override
        public int read(byte[] bytes) throws RemoteException {
            return SerialPort.read(bytes);
        }

        @Override
        public int saveWifiConfig(String ssid, String password, int security) throws RemoteException {
            return Util.saveWifiConfig(AidlService.this, ssid, password, security);
        }

        @Override
        public int simDataSwitch(int index) throws RemoteException {
            return Util.simDataSwitch(AidlService.this, index);
        }

        @Override
        public String getPhoneNumber(int slotIndex) throws RemoteException {
            return Util.getPhoneNumber(AidlService.this, slotIndex);
        }
    };
