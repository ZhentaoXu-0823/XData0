    ...
    private static final ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceDisconnected(ComponentName name) {
            ...
            if(installReceiver != null) {
                installReceiver.unRegister(mContext);
                installReceiver = null;
            }
            if(otaVerityReceiver != null) {
                otaVerityReceiver.unRegister(mContext);
...
//            }
    ...
    public static void setUnsafeMode(boolean open) {
        try {
            iCustomAPI.setDebugMode(open);
        } catch(Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static int resetAPN() {
        try {
            return iCustomAPI.resetAPN();
        } catch(Exception e) {
            e.printStackTrace();
            return -1;
        }
    ...
    public static List<String> getCertificates(int type) {
        try {
            return iCustomAPI.getCertificates(type);
        } catch(Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static void installCA(String path) {
        try {
            iCustomAPI.installCA(path);
        } catch(Exception e) {
            e.printStackTrace();
        }
    }

    public static void uninstallCA(String name) {
        try {
            iCustomAPI.uninstallCA(name);
        } catch(Exception e) {
            e.printStackTrace();
        }
    }

    public static void setNetworkWhitelist(List<String> ipList, List<String> ssidList) {
        try {
            iCustomAPI.setNetworkWhitelist(ipList, ssidList);
        } catch(Exception e) {
            e.printStackTrace();
        }
    }

    public static void setNetworkBlacklist(List<String> ipList, List<String> ssidList) {
        try {
            iCustomAPI.setNetworkBlacklist(ipList, ssidList);
        } catch(Exception e) {
            e.printStackTrace();
        }
    }

    public static void clearNetworkRules() {
        try {
            iCustomAPI.clearNetworkRules();
        } catch(Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static int pin_set_direction(int direction) {
        try {
            return iCustomAPI.pin_set_direction(direction);
        } catch(Exception e) {
            e.printStackTrace();
            return -1;
        }
    ...
    public static int pin_set_output(int level) {
        try {
            return iCustomAPI.pin_set_output(level);
        } catch(Exception e) {
            e.printStackTrace();
            return -1;
        }
    ...
    public static int pin_get_level() {
        try {
            return iCustomAPI.pin_get_level();
        } catch(Exception e) {
            e.printStackTrace();
            return -1;
        }
    ...
    public static boolean open(String port, int baud, int data_bits, int parity, int stop_bits) {
        try {
            return iCustomAPI.open(port, baud, data_bits, parity, stop_bits);
        } catch(Exception e) {
            e.printStackTrace();
            return false;
        }
    ...
    public static int saveWifiConfig(String ssid, String password) {
        return saveWifiConfig(ssid, password, 4/*WifiConfiguration.KeyMgmt.WPA2_PSK*/);
    }
    public static int saveWifiConfig(String ssid, String password, int security) {
        try {
            return iCustomAPI.saveWifiConfig(ssid, password, security);
        } catch(Exception e) {
            e.printStackTrace();
            return -1;
        }
    ...
    public static int simDataSwitch(int index) {
        try {
            return iCustomAPI.simDataSwitch(index);
        } catch (Exception e) {
            e.printStackTrace();
            return -1;
        }
    ...
    public static String getPhoneNumber(int slotIndex) {
        try {
            return iCustomAPI.getPhoneNumber(slotIndex);
        } catch (Exception e) {
            e.printStackTrace();
            return "-1";
        }
